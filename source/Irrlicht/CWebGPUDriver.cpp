...
// WebGPU orchestrator integration
EM_JS(void*, get_external_webgpu_context, (), {
...
EM_JS(void*, request_webgpu_device, (const char* label, int priority), {
